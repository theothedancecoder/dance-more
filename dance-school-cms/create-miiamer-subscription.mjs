...
console.log('🎯 Creating Open week Trial Pass for miiamer88@gmail.com\n');
...
async function createSubscription() {
  try {
    ...
    console.log(`\n🔔 Tell Соломія Мерв'як (miiamer88@gmail.com) to refresh her browser and check her account!`);
