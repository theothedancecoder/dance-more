...
console.log('🎯 Creating Open week Trial Pass for ritoog@gmail.com\n');

const DANCECITY_TENANT_ID = 'sOY5WwoEBY24iuIm0CkYss';
const userEmail = 'ritoog@gmail.com';
...
async function createSubscription() {
  try {
    ...
    console.log(`\n🔔 Tell ritoog@gmail.com to refresh their browser and check their account!`);
