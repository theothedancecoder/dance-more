...
console.log('🔍 Checking user: marcin.i.ciesielski@gmail.com\n');

const userEmail = 'marcin.i.ciesielski@gmail.com';
...
async function checkUser() {
  try {
    ...
    if (subscriptions.length > 0) {
      ...
      console.log(`\n❌ This user has NO subscriptions - needs pass created manually`);
      console.log(`\n❓ Which pass did ${userEmail} purchase?`);
    }
