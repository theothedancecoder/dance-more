...
console.log('🎯 Creating 1 Course (8 weeks) pass for sarasandvik906@gmail.com\n');

const DANCECITY_TENANT_ID = 'sOY5WwoEBY24iuIm0CkYss';
const userEmail = 'sarasandvik906@gmail.com';
const passName = '1 Course (8 weeks)';
  ...
  try {
    ...
    switch (pass.type) {
      ...
      case 'subscription':
        ...
        remainingClips = undefined; // 8-week course subscription
        break;
      default:
    ...
    console.log(`   Classes: ${remainingClips || '8-week course access'}`);
    ...
    console.log(`\n🔔 Tell sarasandvik906@gmail.com to refresh their browser and check their account!`);
